...
const KeyBoard = (props) => {
    const clickButtonHandler = (event) => {
        props.onClickLetter(event.target.innerHTML);
    };
            ...
            <div className={styles.keyBoard}>
                <div className={styles.row}>
                    {FIRST_LETTER_ROW.map((letter) => (
                        <div
                            key={letter}
                            className={`${styles.letter} ${getLetterClass(
                                letter
                            )}`}
                ...
                <div className={styles.row}>
                    <div className={styles.enter} onClick={props.onConfirm}>
                        ENTER
                    </div>
                    <div className={styles.row}>
                    ...
                    <div className={styles.backspace} onClick={props.onRemove}>
                        <svg
                            width="auto"
                            height="auto"
                            viewBox="0 -0.5 25 25"
